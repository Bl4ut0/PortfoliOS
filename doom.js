    ...
    var ASM_CONSTS = [
      ...
      function($0) {
        try {
          ...
          console.log("PortfoliOS: C-callback G_SaveGame triggered for file:", filename);
          var buffer = Module.FS.readFile(filename);
          console.log("PortfoliOS: Successfully read save file from Emscripten FS:", filename, "size:", buffer.length);
          document.dispatchEvent(
          ...
          console.error("PortfoliOS: Error in C-callback G_SaveGame:", err);
        }
      },
